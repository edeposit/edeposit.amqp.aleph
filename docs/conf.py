# -*- coding: utf-8 -*-
#
# E-Deposit documentation build configuration file, created by
...
htmlhelp_basename = 'E-Depositdoc'
...
epub_title = u'E-Deposit'
epub_author = u'Jan Stavěl'
epub_publisher = u'Jan Stavěl'
epub_copyright = u'2013, Jan Stavěl'
